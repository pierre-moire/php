...
pkgs = value_for_platform_family(
  %w{ rhel fedora } => %w{ icu libicu-devel pcre pcre-devel libevent-devel bzip2-devel libc-client-devel curl-devel freetype-devel gmp-devel libjpeg-devel krb5-devel libmcrypt-devel libpng-devel openssl-devel t1lib-devel mhash-devel },
